const QuizQuestions = {
  ...
  questions: [
    ...
    },
    {
      ...
      answer:
        "Immutable state, unidirectional data flow, and single source of truth",
      skill: "Redux",
    },
    {
    ...
    },
    {
      ...
      answer:
        "A function that calculates the new state based on the previous state and an action",
      skill: "Redux",
    },
    {
